...
// Hacer un set para eliminar las palabras repetidas y tener como iterarlas
const words = message.split(" ")
let filteredWords = new Set(words)

// Contar las palabras y ponerlas en un objeto con su resultado
const wordCounts = {};
...
// Hacer el string en el formato pedido
const wordCountsString = Object.entries(wordCounts)
...
console.log("-------- WORD COUNTS STRING --------------");
console.log(wordCountsString);